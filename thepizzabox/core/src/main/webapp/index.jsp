                    ...
                    <div class="menu-container">
                        ...
                        <div class="navbar-logo">
                            <a class="navbar-logo-wrap" href="index.html">
                                <img class="navbar-logo-img" src="img/PizzaBox.png" alt="The Pizza Box Logo">
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
            ...
            <div class="content-md container">
                ...
                <div class="masonry-grid">
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-6">
                        ...
                        <div class="work">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="img/595x483/BJP_Web-boxes3.jpg" alt="Portfolio Image">
                            </div>
                    ...
                    <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="work">
                            <div class="work-overlay">
                                <img class="full-width img-responsive" src="img/595x240/download.gif" alt="Portfolio Image">
                            </div>
                            <div class="work-content">
