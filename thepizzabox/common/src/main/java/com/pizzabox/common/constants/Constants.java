...
public class Constants {
	...
	// home-delivery-flow.xml related
	public static final String ERROR_CHANNEL = "errorChannel";
	public static final String NORTH_ZONE_CHANNEL = "northZoneChannel";
	public static final String SOUTH_ZONE_CHANNEL = "southZoneChannel";
	public static final String EAST_ZONE_CHANNEL = "eastZoneChannel";
	public static final String WEST_ZONE_CHANNEL = "westZoneChannel";
